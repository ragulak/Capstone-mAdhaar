...
public class AutomateRegistration {
	String path= "P:\\\\95\\\\chromedriver.exe";
  ...
  public void f() {
		...
		WebElement username =driver.findElement(By.id("inputEmail4"));
		username.sendKeys("Divya");	
		WebElement email =driver.findElement(By.id("inputEmail4"));
		email.sendKeys("divyavd@gmail.com");
		WebElement pwd =driver.findElement(By.id("inputPassword4"));
		pwd.sendKeys("Divya@23");
		WebElement cpwd =driver.findElement(By.id("inputPassword4"));
		cpwd.sendKeys("Divya@23");
